...
# Logging
from envs.util import test_model, test_model2
...
parser.add_argument('--load_path',
                    default='D:\\python\\gym\\gym-hpa\\mywork_vpa2\\policy\\logs\\a2c_env_test_one_app_vpa_gym2_goal_cost_k8s_True_totalSteps_10000\\a2c_env_test_one_app_vpa_gym2_goal_cost_k8s_True_totalSteps_10000_4500_steps.zip',
                    help='Loading path, ex: logs/model/test.zip')
parser.add_argument('--test_path', default='D:\\python\\gym\\gym-hpa\\mywork_vpa2\\policy\\a2c_similutator.zip', help='Testing path, ex: logs/model/test.zip')
...
def main():
    ...
    if testing:
        ...
        test_model2(model, env,n_steps=25)


def myjob():
    hostname = '172.31.234.113'  # 远程服务器的主机名或 IP 地址
